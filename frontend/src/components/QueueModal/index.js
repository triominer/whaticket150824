...
const QueueSchema = Yup.object().shape({
  ...
  urlFlow: Yup.string().min(2, "Too Short!").max(100, "Too Long!"),
  tokenFlow: Yup.string().min(2, "Too Short!").max(100, "Too Long!"),
  name: Yup.string()
    .min(2, "Too Short!")
    .max(50, "Too Long!")
    .required("Required"),
...
<Field
                          as={TextField}
                          label={i18n.t("FLOW URL")}
                          autoFocus
                          name="urlFlow"
                          error={touched.urlFlow && Boolean(errors.urlFlow)}
                          helperText={touched.urlFlow && errors.urlFlow}
                          variant="outlined"
                          margin="dense"
                          className={classes.textField}
                        />
                        ...
                        <Field
                          as={TextField}
                          label={i18n.t("Flow Token")}
                          autoFocus
                          name="tokenFlow"
                          error={touched.tokenFlow && Boolean(errors.tokenFlow)}
                          helperText={touched.tokenFlow && errors.tokenFlow}
                          variant="outlined"
                          margin="dense"
                          className={classes.textField}
                        />
