...
const TicketListItemCustom = ({ ticket }) => {
  ...
  const wppoficialHandleSend = async (id) => {
        ...
        {ticket.queue?.name !== null && (
          ...
          {ticket.whatsapp?.name !== null && (
            <Badge
              className={classes.Radiusdot}
              style={{
                backgroundColor: ticket.channel === "wppoficial" ? "green" : "#002060",
                height: 16,
                padding: 4,
                position: "inherit",
                borderRadius: 2,
    ...
    <React.Fragment key={ticket.id}>
      ...
      >
        ...
        <ListItemText
          ...
          <Tooltip title={`WhatsApp Oficial: ${ticketUser}`}>
            <WhatsAppIcon fontSize="small" style={{
                  color: blue[700],
                  cursor: "pointer",
                  marginRight: "118px",
        ...
        {ticket.channel === "facebook" && (
          ...
          <Tooltip title={`telegram a${ticketUser}`}>
            <Telegram fontSize="small" style={{ color: blue[700] }} />
          </Tooltip>
        )}
              </Typography>
